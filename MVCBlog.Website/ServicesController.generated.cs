...
namespace MVCBlog.Website.Controllers
{
    public partial class ServicesController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ServicesController Actions { get { return MVC.Services; } }
        ...
        public class ViewsClass
        {
            ...
            public readonly string Create = "~/Views/Services/Create.cshtml";
            public readonly string Delete = "~/Views/Services/Delete.cshtml";
            public readonly string Details = "~/Views/Services/Details.cshtml";
            public readonly string Edit = "~/Views/Services/Edit.cshtml";
            public readonly string Index = "~/Views/Services/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ServicesController : MVCBlog.Website.Controllers.ServicesController
    {
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, MVCBlog.Core.Entities.Service service);

        [NonAction]
        public override System.Web.Mvc.ActionResult Create(MVCBlog.Core.Entities.Service service)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "service", service);
            CreateOverride(callInfo, service);
            return callInfo;
        }
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, MVCBlog.Core.Entities.Service service);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(MVCBlog.Core.Entities.Service service)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "service", service);
            EditOverride(callInfo, service);
            return callInfo;
        }
