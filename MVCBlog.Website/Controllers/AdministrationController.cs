...
namespace MVCBlog.Website.Controllers
{
    ...
    public partial class AdministrationController : Controller
    {
        ...
        //private readonly ICommandHandler<AddCategoryCommand> addCategoryCommandHandler;
        ...
        public async virtual Task<ActionResult> EditBlogEntry(Guid? id, [Bind(Include = "Header, Author, ShortContent, Content, Visible")]BlogEntry blogEntry, FormCollection formValues)
        {
            ...
            if (id.HasValue)
            {
                ...
                existingBlogEntry.Visible = true;
        ...
        /// <returns>A view showing all <see cref="MVCBlog.Core.Entities.Image">Images</see>.</returns>
        [HttpPost]
        public async virtual Task<ActionResult> ImageUpload(IEnumerable<HttpPostedFileBase> files)
        {
        ...
        [HttpPost]
        public async virtual Task<ActionResult> ImageRemove(string id)
        {
            var imagen = this.repository.Images.FirstOrDefault(_ => _.Id == new Guid(id));
            this.repository.Images.Remove(imagen);
